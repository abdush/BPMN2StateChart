...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ecore="http://www.eclipse.org/emf/2002/Ecore" xmlns:pm="http://BPMN/Simplified">
  <pm:Process xmi:id="bikeshop" id="bikeshop" name="Default Process">
    ...
    <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_2" id="SequenceFlow_2" sourceRef="StartEvent_1" targetRef="/0/@flowElements.49"/>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="DataObject_1" id="DataObject_1" name="Order [no trade-in]" incoming="/0/@flowElements.43" outgoing="/0/@flowElements.47">
      <dataState xmi:id="DataState_1" id="DataState_1" name="no trade-in"/>
    </flowElements>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_3" id="_DataObjectReference_3" name="Order [not ordered at supplier]" incoming="/0/@flowElements.44" outgoing="/0/@flowElements.46">
      <dataState xmi:id="DataState_2" id="DataState_2" name="not ordered at supplier"/>
    </flowElements>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_4" id="_DataObjectReference_4" name="Order [accessories unknown]" incoming="/0/@flowElements.45" outgoing="/0/@flowElements.48">
    ...
    <flowElements xsi:type="pm:ExclusiveGateway" xmi:id="ExclusiveGateway_1" id="ExclusiveGateway_1" name="Exclusive Gateway 1" incoming="/0/@flowElements.47" outgoing="SequenceFlow_8 SequenceFlow_10" gatewayDirection="Diverging"/>
    ...
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_5" id="_DataObjectReference_5" name="Order [ordered at supplier]" incoming="/0/@flowElements.46" outgoing="SequenceFlow_15">
    ...
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_6" id="_DataObjectReference_6" name="Order [accessories fixed]" incoming="/0/@flowElements.48" outgoing="SequenceFlow_12">
    ...
    <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_1" sourceRef="/0/@flowElements.49" targetRef="DataObject_1"/>
    ...
    <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#96" incoming="SequenceFlow_2" outgoing="/0/@flowElements.43 /0/@flowElements.44 /0/@flowElements.45" gatewayDirection="Diverging"/>
  </pm:Process>
