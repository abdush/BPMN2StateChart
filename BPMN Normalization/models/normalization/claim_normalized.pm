...
<pm:Process xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:pm="http://BPMN/Simplified" xmi:id="claim" id="claim" name="Default Process">
  ...
  <flowElements xsi:type="pm:ObjectNode" xmi:id="DataObject_1" id="DataObject_1" name="Claim [Received]" incoming="//@flowElements.52" outgoing="//@flowElements.59">
  ...
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_5" id="_DataObjectReference_5" name="Claim [policy checked]" incoming="//@flowElements.56" outgoing="//@flowElements.62">
    <dataState xmi:id="DataState_4" id="DataState_4" name="policy checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_6" id="_DataObjectReference_6" name="Claim [damage checked]" incoming="//@flowElements.58" outgoing="//@flowElements.61">
    <dataState xmi:id="DataState_5" id="DataState_5" name="damage checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_7" id="_DataObjectReference_7" name="Claim [confirmed]" incoming="//@flowElements.60" outgoing="SequenceFlow_22">
    <dataState xmi:id="DataState_6" id="DataState_6" name="confirmed"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_8" id="_DataObjectReference_8" name="Claim [decided]" incoming="//@flowElements.63" outgoing="//@flowElements.64 //@flowElements.66">
    <dataState xmi:id="DataState_7" id="DataState_7" name="decided"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_9" id="_DataObjectReference_9" name="Claim [Rejected]" incoming="//@flowElements.65" outgoing="SequenceFlow_18">
    <dataState xmi:id="DataState_8" id="DataState_8" name="Rejected"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_10" id="_DataObjectReference_10" name="Claim [assessed]" incoming="//@flowElements.67" outgoing="//@flowElements.68">
    <dataState xmi:id="DataState_9" id="DataState_9" name="assessed"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_11" id="_DataObjectReference_11" name="Claim [settled]" incoming="//@flowElements.69" outgoing="SequenceFlow_16">
    <dataState xmi:id="DataState_10" id="DataState_10" name="settled"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_12" id="_DataObjectReference_12" name="Claim [archived]" incoming="//@flowElements.70" outgoing="SequenceFlow_21">
  ...
  <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_3" id="SequenceFlow_3" sourceRef="ParallelGateway_1" targetRef="//@flowElements.76"/>
  ...
  <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_8" id="SequenceFlow_8" sourceRef="ParallelGateway_2" targetRef="//@flowElements.78"/>
  <flowElements xsi:type="pm:Activity" xmi:id="Task_2" id="Task_2" name="Confirm receipt" incoming="//@flowElements.75" outgoing="//@flowElements.60"/>
  ...
  <flowElements xsi:type="pm:Activity" xmi:id="Task_5" id="Task_5" name="Decide" incoming="//@flowElements.77" outgoing="//@flowElements.91"/>
  ...
  <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_10" id="SequenceFlow_10" sourceRef="ExclusiveGateway_1" targetRef="//@flowElements.80" guard="[else]"/>
  ...
  <flowElements xsi:type="pm:Activity" xmi:id="Task_6" id="Task_6" name="Reject" incoming="//@flowElements.79" outgoing="//@flowElements.65"/>
  ...
  <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_13" id="SequenceFlow_13" sourceRef="ParallelGateway_3" targetRef="//@flowElements.82"/>
  ...
  <flowElements xsi:type="pm:Activity" xmi:id="Task_8" id="Task_8" name="Determine cost" incoming="//@flowElements.81" outgoing="//@flowElements.93"/>
  <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_14" id="SequenceFlow_14" sourceRef="//@flowElements.94" targetRef="//@flowElements.84"/>
  <flowElements xsi:type="pm:Activity" xmi:id="Task_9" id="Task_9" name="Pay" incoming="//@flowElements.83" outgoing="//@flowElements.69"/>
  ...
  <flowElements xsi:type="pm:Activity" xmi:id="Task_10" id="Task_10" name="Notify client" incoming="SequenceFlow_20" outgoing="//@flowElements.70"/>
  ...
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_3" sourceRef="DataObject_1" targetRef="//@flowElements.76"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_6" sourceRef="Task_2" targetRef="_DataObjectReference_7"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_5" sourceRef="_DataObjectReference_6" targetRef="//@flowElements.78"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_6" sourceRef="_DataObjectReference_5" targetRef="//@flowElements.78"/>
  ...
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_8" sourceRef="_DataObjectReference_8" targetRef="//@flowElements.80"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_8" sourceRef="Task_6" targetRef="_DataObjectReference_9"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_7" sourceRef="_DataObjectReference_8" targetRef="//@flowElements.82"/>
  ...
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_9" sourceRef="_DataObjectReference_10" targetRef="//@flowElements.84"/>
  ...
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#73" name="Parallel Gateway 1Claim [policy not checked]" incoming="SequenceFlow_4 //@flowElements.55" outgoing="//@flowElements.71" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#74" sourceRef="//@flowElements.74" targetRef="Task_4"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#75" name="Parallel Gateway 1Claim [damage not checked]" incoming="SequenceFlow_5 //@flowElements.57" outgoing="//@flowElements.73" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#76" sourceRef="//@flowElements.76" targetRef="Task_2"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#77" name="Parallel Gateway 1Claim [Received]" incoming="SequenceFlow_3 //@flowElements.59" outgoing="//@flowElements.75" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#78" sourceRef="//@flowElements.78" targetRef="Task_5"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#79" name="Parallel Gateway 2Claim [damage checked]Claim [policy checked]" incoming="SequenceFlow_8 //@flowElements.61 //@flowElements.62" outgoing="//@flowElements.77" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#80" sourceRef="//@flowElements.80" targetRef="Task_6"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#81" name="Exclusive Gateway 1Claim [decided]" incoming="SequenceFlow_10 //@flowElements.64" outgoing="//@flowElements.79" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#82" sourceRef="//@flowElements.82" targetRef="Task_8"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#83" name="Parallel Gateway 3Claim [decided]" incoming="SequenceFlow_13 //@flowElements.66" outgoing="//@flowElements.81" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#84" sourceRef="//@flowElements.84" targetRef="Task_9"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#85" name="Determine costClaim [assessed]" incoming="SequenceFlow_14 //@flowElements.68" outgoing="//@flowElements.83" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#86" sourceRef="Task_1" targetRef="//@flowElements.86"/>
  <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#87" name="Parallel Gateway 1Claim [Received]Claim [policy not checked]Claim [damage not checked]" incoming="//@flowElements.85" outgoing="SequenceFlow_2 //@flowElements.52 //@flowElements.53 //@flowElements.54" gatewayDirection="Diverging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#88" sourceRef="Task_3" targetRef="//@flowElements.88"/>
  <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#89" name="Parallel Gateway 2Claim [policy checked]" incoming="//@flowElements.87" outgoing="SequenceFlow_6 //@flowElements.56" gatewayDirection="Diverging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#90" sourceRef="Task_4" targetRef="//@flowElements.90"/>
  <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#91" name="Parallel Gateway 2Claim [damage checked]" incoming="//@flowElements.89" outgoing="SequenceFlow_7 //@flowElements.58" gatewayDirection="Diverging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#92" sourceRef="Task_5" targetRef="//@flowElements.92"/>
  <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#93" name="Exclusive Gateway 1Claim [decided]" incoming="//@flowElements.91" outgoing="SequenceFlow_9 //@flowElements.63" gatewayDirection="Diverging"/>
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#94" sourceRef="Task_8" targetRef="//@flowElements.94"/>
  <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#95" name="Determine costClaim [assessed]Claim [assessed]" incoming="//@flowElements.93" outgoing="SequenceFlow_14 //@flowElements.67" gatewayDirection="Diverging"/>
</pm:Process>
