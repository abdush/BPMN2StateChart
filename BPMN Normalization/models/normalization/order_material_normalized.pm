...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ecore="http://www.eclipse.org/emf/2002/Ecore" xmlns:pm="http://BPMN/Simplified">
  <pm:Process xmi:id="order_material" id="order_material" name="Default Process">
    <flowElements xsi:type="pm:StartEvent" xmi:id="StartEvent_1" id="StartEvent_1" outgoing="/0/@flowElements.37"/>
    <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_2" id="SequenceFlow_2" sourceRef="DataObject_1" targetRef="Task_1"/>
    <flowElements xsi:type="pm:Activity" xmi:id="Task_1" id="Task_1" name="Prepare Purchase Request" incoming="SequenceFlow_2" outgoing="/0/@flowElements.38"/>
    ...
    <flowElements xsi:type="pm:Activity" xmi:id="Task_2" id="Task_2" name="Obtain Account's Manager Approval" incoming="SequenceFlow_3" outgoing="/0/@flowElements.39"/>
    ...
    <flowElements xsi:type="pm:Activity" xmi:id="Task_4" id="Task_4" name="Submit Signed Purchase Request" incoming="SequenceFlow_8" outgoing="/0/@flowElements.40"/>
    ...
    <flowElements xsi:type="pm:Activity" xmi:id="Task_3" id="Task_3" name="Obtain Authorization Signature" incoming="SequenceFlow_5" outgoing="/0/@flowElements.41"/>
    ...
    <flowElements xsi:type="pm:ExclusiveGateway" xmi:id="ExclusiveGateway_4" id="ExclusiveGateway_4" name="Merge 2" incoming="SequenceFlow_14 SequenceFlow_15" outgoing="SequenceFlow_16" gatewayDirection="Converging"/>
    ...
    <flowElements xsi:type="pm:Activity" xmi:id="Task_9" id="Task_9" name="Order Requested Material" incoming="SequenceFlow_16" outgoing="/0/@flowElements.42"/>
    ...
    <flowElements xsi:type="pm:ObjectNode" xmi:id="DataObject_1" id="DataObject_1" name="Purchase Request [Not prepared]" incoming="/0/@flowElements.37" outgoing="SequenceFlow_2">
      <dataState xmi:id="DataState_1" id="DataState_1" name="Not prepared"/>
    </flowElements>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_3" id="_DataObjectReference_3" name="Purchase Request [Prepared]" incoming="/0/@flowElements.38" outgoing="SequenceFlow_3">
      <dataState xmi:id="DataState_3" id="DataState_3" name="Prepared"/>
    </flowElements>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_4" id="_DataObjectReference_4" name="Purchase Request [Approved]" incoming="/0/@flowElements.39" outgoing="SequenceFlow_4">
      <dataState xmi:id="DataState_5" id="DataState_5" name="Approved"/>
    </flowElements>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_5" id="_DataObjectReference_5" name="Purchase Request [Authorized]" incoming="/0/@flowElements.41" outgoing="SequenceFlow_7">
      <dataState xmi:id="DataState_7" id="DataState_7" name="Authorized"/>
    </flowElements>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_6" id="_DataObjectReference_6" name="Purchase Request [Submitted]" incoming="/0/@flowElements.40" outgoing="SequenceFlow_9">
      <dataState xmi:id="DataState_8" id="DataState_8" name="Submitted"/>
    </flowElements>
    <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_7" id="_DataObjectReference_7" name="Purchase Request [Ordered]" incoming="/0/@flowElements.42" outgoing="SequenceFlow_17">
