...
<pm:Process xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:pm="http://BPMN/Simplified" xmi:id="claim" id="claim" name="Default Process">
  ...
  <flowElements xsi:type="pm:SequenceFlow" xmi:id="SequenceFlow_1" id="SequenceFlow_1" sourceRef="StartEvent_1" targetRef="//@flowElements.35"/>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="DataObject_1" id="DataObject_1" name="Claim [Received]" incoming="//@flowElements.24" outgoing="//@flowElements.29">
    <dataState xmi:id="DataState_1" id="DataState_1" name="received"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_3" id="_DataObjectReference_3" name="Claim [policy not checked]" incoming="//@flowElements.25" outgoing="//@flowElements.27">
    <dataState xmi:id="DataState_2" id="DataState_2" name="policy not checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_4" id="_DataObjectReference_4" name="Claim [damage not checked]" incoming="//@flowElements.26" outgoing="//@flowElements.28">
    <dataState xmi:id="DataState_3" id="DataState_3" name="damage not checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_5" id="_DataObjectReference_5" name="Claim [policy checked]" incoming="//@flowElements.27" outgoing="//@flowElements.31">
    <dataState xmi:id="DataState_4" id="DataState_4" name="policy checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_6" id="_DataObjectReference_6" name="Claim [damage checked]" incoming="//@flowElements.28" outgoing="//@flowElements.30">
    <dataState xmi:id="DataState_5" id="DataState_5" name="damage checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_7" id="_DataObjectReference_7" name="Claim [confirmed]" incoming="//@flowElements.29" outgoing="SequenceFlow_22">
    <dataState xmi:id="DataState_6" id="DataState_6" name="confirmed"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_8" id="_DataObjectReference_8" name="Claim [decided]" incoming="//@flowElements.33" outgoing="SequenceFlow_10 SequenceFlow_11">
  ...
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_10" id="_DataObjectReference_10" name="Claim [assessed]" incoming="SequenceFlow_11" outgoing="//@flowElements.32">
    <dataState xmi:id="DataState_9" id="DataState_9" name="assessed"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_11" id="_DataObjectReference_11" name="Claim [settled]" incoming="//@flowElements.32" outgoing="SequenceFlow_16">
  ...
  <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_1" sourceRef="//@flowElements.35" targetRef="DataObject_1"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_2" sourceRef="//@flowElements.35" targetRef="_DataObjectReference_3"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_3" sourceRef="//@flowElements.35" targetRef="_DataObjectReference_4"/>
  ...
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_5" sourceRef="_DataObjectReference_6" targetRef="//@flowElements.34"/>
  <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_6" sourceRef="_DataObjectReference_5" targetRef="//@flowElements.34"/>
  ...
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#78" sourceRef="//@flowElements.34" targetRef="_DataObjectReference_8"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#79" name="Parallel Gateway 2Claim [damage checked]Claim [policy checked]" incoming="//@flowElements.30 //@flowElements.31" outgoing="//@flowElements.33" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#87" name="Parallel Gateway 1Claim [Received]Claim [policy not checked]Claim [damage not checked]" incoming="SequenceFlow_1" outgoing="//@flowElements.24 //@flowElements.25 //@flowElements.26" gatewayDirection="Diverging"/>
</pm:Process>
