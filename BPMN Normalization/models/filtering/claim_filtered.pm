...
<pm:Process xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:pm="http://BPMN/Simplified" xmi:id="claim" id="claim" name="Default Process">
  ...
  <flowElements xsi:type="pm:ObjectNode" xmi:id="DataObject_1" id="DataObject_1" name="Claim [Received]" incoming="//@flowElements.24" outgoing="//@flowElements.32">
  ...
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_5" id="_DataObjectReference_5" name="Claim [policy checked]" incoming="//@flowElements.27" outgoing="//@flowElements.30">
    <dataState xmi:id="DataState_4" id="DataState_4" name="policy checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_6" id="_DataObjectReference_6" name="Claim [damage checked]" incoming="//@flowElements.28" outgoing="//@flowElements.29">
    <dataState xmi:id="DataState_5" id="DataState_5" name="damage checked"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_7" id="_DataObjectReference_7" name="Claim [confirmed]" incoming="//@flowElements.32" outgoing="SequenceFlow_22">
  ...
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_10" id="_DataObjectReference_10" name="Claim [assessed]" incoming="SequenceFlow_11" outgoing="//@flowElements.31">
    <dataState xmi:id="DataState_9" id="DataState_9" name="assessed"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_11" id="_DataObjectReference_11" name="Claim [settled]" incoming="//@flowElements.31" outgoing="SequenceFlow_16">
  ...
  <flowElements xsi:type="pm:SequenceFlow" id="sequenceFlow#FlowElement#76" sourceRef="//@flowElements.34" targetRef="_DataObjectReference_8"/>
  <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#77" incoming="//@flowElements.29 //@flowElements.30" outgoing="//@flowElements.33" gatewayDirection="Converging"/>
  <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#87" incoming="SequenceFlow_1" outgoing="//@flowElements.24 //@flowElements.25 //@flowElements.26" gatewayDirection="Diverging"/>
</pm:Process>
