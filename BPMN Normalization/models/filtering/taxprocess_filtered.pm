...
<pm:Process xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:pm="http://BPMN/Simplified" xmi:id="taxprocess" id="taxprocess" name="Default Process">
  ...
  <flowElements xsi:type="pm:ExclusiveGateway" xmi:id="ExclusiveGateway_1" id="ExclusiveGateway_1" name="Exclusive Gateway 1" incoming="//@flowElements.18" outgoing="SequenceFlow_6 SequenceFlow_7" gatewayDirection="Diverging"/>
  ...
  <flowElements xsi:type="pm:EndEvent" xmi:id="EndEvent_2" id="EndEvent_2" name="End Event 2" incoming="//@flowElements.19"/>
  ...
  <flowElements xsi:type="pm:ParallelGateway" xmi:id="ParallelGateway_2" id="ParallelGateway_2" name="Parallel Gateway 2" incoming="//@flowElements.22 //@flowElements.23" outgoing="SequenceFlow_19" gatewayDirection="Converging"/>
  ...
  <flowElements xsi:type="pm:ObjectNode" xmi:id="DataObject_1" id="DataObject_1" name="declaration [submitted]" incoming="SequenceFlow_2" outgoing="//@flowElements.18">
    <dataState xmi:id="DataState_1" id="DataState_1" name="submitted"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_15" id="_DataObjectReference_15" name="declaration [rejected]" incoming="SequenceFlow_6" outgoing="//@flowElements.19">
    <dataState xmi:id="DataState_2" id="DataState_2" name="rejected"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_16" id="_DataObjectReference_16" name="declaration [accepted]" incoming="SequenceFlow_10" outgoing="//@flowElements.23">
    <dataState xmi:id="DataState_3" id="DataState_3" name="accepted"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_17" id="_DataObjectReference_17" name="declaration [processed]" incoming="SequenceFlow_12" outgoing="//@flowElements.20">
    <dataState xmi:id="DataState_4" id="DataState_4" name="processed"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_18" id="_DataObjectReference_18" name="declaration [assessed]" incoming="//@flowElements.20" outgoing="//@flowElements.21">
    <dataState xmi:id="DataState_5" id="DataState_5" name="assessed"/>
  </flowElements>
  <flowElements xsi:type="pm:ObjectNode" xmi:id="_DataObjectReference_19" id="_DataObjectReference_19" name="declaration [returned]" incoming="//@flowElements.21" outgoing="//@flowElements.22">
