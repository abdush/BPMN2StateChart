...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ecore="http://www.eclipse.org/emf/2002/Ecore" xmlns:pm="http://BPMN/Simplified">
  <pm:Process xmi:id="claim" id="claim" name="Default Process">
    <flowElements xsi:type="pm:StartEvent" xmi:id="StartEvent_1" id="StartEvent_1" name="StartEvent_1" outgoing="SequenceFlow_1"/>
    ...
    <flowElements xsi:type="pm:EndEvent" xmi:id="EndEvent_1" id="EndEvent_1" name="EndEvent_1" incoming="SequenceFlow_21"/>
    ...
    <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#77" name="join#FlowElement#77" incoming="/0/@flowElements.29 /0/@flowElements.30" outgoing="/0/@flowElements.33" gatewayDirection="Converging"/>
    <flowElements xsi:type="pm:ParallelGateway" id="fork#FlowElement#87" name="fork#FlowElement#87" incoming="SequenceFlow_1" outgoing="/0/@flowElements.24 /0/@flowElements.25 /0/@flowElements.26" gatewayDirection="Diverging"/>
  </pm:Process>
