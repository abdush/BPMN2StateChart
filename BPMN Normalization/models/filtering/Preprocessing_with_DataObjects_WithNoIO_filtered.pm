...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ecore="http://www.eclipse.org/emf/2002/Ecore" xmlns:pm="http://BPMN/Simplified">
  <pm:Process xmi:id="_J84mQeneEeOgCMDZjxiKRQ" id="_J84mQeneEeOgCMDZjxiKRQ" name="process_sample">
    <flowElements xsi:type="pm:ObjectNode" xmi:id="DataObject_1" id="DataObject_1" name="Data Object 1" incoming="/0/@flowElements.22" outgoing="/0/@flowElements.13">
    ...
    <flowElements xsi:type="pm:StartEvent" xmi:id="_J84mQuneEeOgCMDZjxiKRQ" id="_J84mQuneEeOgCMDZjxiKRQ" outgoing="/0/@flowElements.22"/>
    ...
    <flowElements xsi:type="pm:SequenceFlow" xmi:id="_7EecY-oxEeO7IP1X9T78Pg" id="_7EecY-oxEeO7IP1X9T78Pg" sourceRef="_7EecYuoxEeO7IP1X9T78Pg" targetRef="/0/@flowElements.20" guard="x > 10"/>
    <flowElements xsi:type="pm:SequenceFlow" xmi:id="_7EecZOoxEeO7IP1X9T78Pg" id="_7EecZOoxEeO7IP1X9T78Pg" sourceRef="_7EecYuoxEeO7IP1X9T78Pg" targetRef="/0/@flowElements.20" guard="x &lt;= 10"/>
    ...
    <flowElements xsi:type="pm:ObjectFlow" id="DataInputAssociation_1" sourceRef="DataObject_1" targetRef="/0/@flowElements.21"/>
    <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_2" sourceRef="/0/@flowElements.21" targetRef="_DataObjectReference_3"/>
    <flowElements xsi:type="pm:ObjectFlow" id="DataOutputAssociation_3" sourceRef="/0/@flowElements.21" targetRef="_DataObjectReference_4"/>
    ...
    <flowElements xsi:type="pm:ParallelGateway" id="join#FlowElement#42" incoming="/0/@flowElements.13" outgoing="/0/@flowElements.14 /0/@flowElements.15" gatewayDirection="Converging"/>
